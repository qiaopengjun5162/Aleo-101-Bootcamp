...
// per docs/02-data-model.md §3.1 packUtf8ToU128Array.
...
function unpackU128ArrayToBytes(values: readonly bigint[], dataLen: number): Uint8Array {
  const out: number[] = [];
...
function decodePIIPayloadFromString(payload: string): PIIPayloadDecoded {
